...
/** @brief Private libleechmission variable that's visible only for inlining in tr_time () */
 ...
 * If something blocks the libleechmission thread for more than a second,
...
/** @brief Private libleechmission function to update tr_time ()'s counter */
