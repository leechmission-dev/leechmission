...
#ifndef __LIBLEECHMISSION_ANNOUNCER_MODULE___
 #error only the libleechmission announcer module should #include this header.
#endif

#ifndef _TR_ANNOUNCER_COMMON_H_
#define _TR_ANNOUNCER_COMMON_H_

#include "leechmission.h" /* SHA_DIGEST_LENGTH */
...
typedef struct
{
   ...
   * leechmission treats this as the interval for periodic announces */
  int interval;

  /* minimum interval between announces. (optional)
   * leechmission treats this as the min interval for manual announces */
  int min_interval;
