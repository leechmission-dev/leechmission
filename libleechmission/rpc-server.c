  ...
  if (!webClientDir || !*webClientDir)
    {
        send_simple_response (req, HTTP_NOTFOUND,
          ...
          "#define PACKAGE_DATA_DIR in libleechmission/platform.c "
      ...
      if (!isAddressAllowed (server, req->remote_host))
        {
          send_simple_response (req, 403,
            ...
            "<p>If you're still using ACLs, use a whitelist instead. See the leechmission-daemon manpage for details.</p>");
        }
