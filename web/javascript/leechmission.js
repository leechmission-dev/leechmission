	...
	****/
	...
	onMenuClicked: function(ev)
	{
		...
		else switch (id)
		{
			...
			case 'homepage':
				window.open('http://www.leechmissionbt.com/');
				break;

			case 'tipjar':
				window.open('http://www.leechmissionbt.com/donate.php');
				break;	
	...
	promptToRemoveTorrents: function(torrents) {
		if (torrents.length === 1)
		{
			...
			dialog.confirm(header, message, 'Remove', 'leechmission.removeTorrents', torrents);
		}
		else
		{
	...
	promptToRemoveTorrentsAndData:function(torrents)
	{
		if (torrents.length === 1)
		{
			...
			dialog.confirm(header, message, 'Remove', 'leechmission.removeTorrentsAndData', torrents);
		}
		else
		{
